...
doc = open(xml).read#.encode(Encoding::UTF_8)
#puts doc
...
ardoc.each do |rsub|
	stfile = []
	stfile << "\xEF\xBB\xBF"+'[Script Info]'
	...
	stfile << 'Style: taiga_1,Open Sans Semibold,44,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,-1,0,0,0,100,100,0,0,1,1.4,0,2,10,10,25,1'
	stfile << ''
	stfile << '[Events]'
	...
	p lang
	stfile.each do |str|
		File.open('tmp/'+ARGV[1]+'/'+ARGV[1]+'.'+lang+'.ass', 'a'){ |file| file.puts  str }
	end
end
